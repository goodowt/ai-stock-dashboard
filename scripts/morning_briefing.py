...
#
# 매일 한국 장 시작 전(07:23 KST)에 실행: 미국 증시 종가, 원달러 환율,
# 국제유가(WTI), 반도체 관련주(엔비디아/마이크론), 그리고 연준·금리, 미국
# 대통령, 미국 경제지표, 관세/무역분쟁, 반도체·AI, 지정학 리스크, 빅테크
# 실적, 국제유가/원자재, 중국 경제 등 증시에 영향을 줄 수 있는 주요 뉴스를
# 모아 텔레그램으로 요약 발송한다.
...
NEWS_QUERIES = {
    ...
    "관세/무역분쟁": "관세 무역분쟁 미국",
    "반도체/AI": "반도체 AI 증시",
    "지정학 리스크": "지정학 리스크 전쟁 증시",
    "빅테크 실적": "빅테크 실적 발표",
    "국제유가/원자재": "국제유가 원자재 시장",
    "중국 경제": "중국 경제 증시",
}
